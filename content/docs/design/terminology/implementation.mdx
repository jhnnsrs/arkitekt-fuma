...
description: A Template is a concrete implementation of an abstract Node within a specific application, defining how a bioimage task actually runs.
---
...
<div className="mt-2">
<img src="/docs/design/terminology/node-template.png" alt="Nodes and Templates" />
