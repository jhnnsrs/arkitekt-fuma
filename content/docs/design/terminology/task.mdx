---
title: Assignation
description: An Assignation is the process of running a Task in Arkitekt, assigned directly to an action and able to stream results over time.
---
...
**directly** to a node (an action); Arkitekt then takes care of "where" and "how"
...
<div className="mt-2">
<img src="/docs/design/terminology/assignment.png" alt="The stages of an assignation" />
...
You search the node "Segment Cells" and simply assign your data to it — you do not care
