...
description: Nodes are a core conceptual element of Arkitekt that represent a bioimage task by its inputs and outputs, independent of any implementation.
---
...
<div className="mt-2">
<img src="/docs/design/terminology/node-template.png" alt="Arkitekts nodes and templates" />
...
<div className="mt-2">
<img src="/docs/design/terminology/node-stream.png" alt="Arkitekts nodes and templates" />
