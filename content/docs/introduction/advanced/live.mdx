---
title: Live Analysis
description: How to build and run a streaming (live) analysis workflow in Arkitekt using generator nodes to process images as they are acquired.
---

import { DisplayWorkflow } from "@/components/reaktion/DisplayWorkflow";
...
<img src="/docs/introduction/advanced/node-stream.png" alt="Functional Nodes vs Stream Nodes" />
