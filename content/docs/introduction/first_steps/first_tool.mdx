...
description: Learn what Apps, Plugins, and Nodes are in Arkitekt by installing your first plugin app and reserving a node to convert a file.
---

import { InstallRepoButton } from "@/components/InstallRepoButton";
...
<Callout type="info" title="About Reservations">
...
<video
  ...
  width={"100%"}
>
  <source src="/docs/introduction/first_steps/reserve.webm" />
</video>
...
<Callout type="info" title="Why Reservations">
