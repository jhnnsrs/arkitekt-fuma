---
title: Basics
description: An introduction to Arkitekt as an installable server platform that acts as a middleman and datahub for image analysis tools.
---

## Basics

Arkitekt is software platform for image analysis. As explained in the [philosophy](/docs/design/philosophy/why) section, Arkitekt wants to act as
