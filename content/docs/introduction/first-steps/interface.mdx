...
- Understand the basics of the [Authentication and Authorization](/docs/design/architecture/security) process
...
and how we ensure that your data is [safe and secure](/docs/design/architecture/security)
