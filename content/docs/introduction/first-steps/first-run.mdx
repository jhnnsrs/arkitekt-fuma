...
In Arkitekt, workflows and tasks are executed immediately — just assign your data to an action and Arkitekt routes it to a connected agent automatically. There is no booking or setup step.
