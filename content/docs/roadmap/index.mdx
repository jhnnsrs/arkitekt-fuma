...
Arkitekt lets you assign tasks to actions directly — no booking or setup step. Just point your data at an action and
an available agent runs it. This makes starting a task far more intuitive and removed a whole class of confusing
